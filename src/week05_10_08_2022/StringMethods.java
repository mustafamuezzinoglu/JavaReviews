...
public class StringMethods {
    public static void main(String[] args) {
        ...
        System.out.println(str1); //we will have spaces in here because String class is immutable
...
//        if we want to get some part of ther string we need to use substring()
        //01234
        String subs = "Cydeo";
//        get the yde from the subs variable
        System.out.println(subs.substring(1, 4));

//        get the Cy from the subs variable
...
//        if we want to check our string empty or not we need to use isEmpty() method
        String emptyWord = " ";
        System.out.println(emptyWord.isEmpty());

//        if we want to check our string empty or not we need to use isBlank() method
        String blankWord = "  "; //it is ckecking spaces
        System.out.println(blankWord.isBlank());

//        if we want to compare two string values wit exact matching we can use equals()

//        if we want to compare two string values wit exact matching (case sensitivity) we can use equalsIgnoreCase()
