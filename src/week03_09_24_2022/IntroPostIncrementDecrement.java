...
public class IntroPostIncrementDecrement {
    public static void main(String[] args) {
        ...
        System.out.println("b= "+ b--); // first do action (print) we will print 10 and the second change value 9
        System.out.println("b= "+ b--); // ı will print 9 and decrement it will be 8 for next statement
